...
{
	$idm = @$_GET["id"];
		$bak = @mysql_query("select * from satilik where id='$idm'");
		$tambak=@mysql_fetch_assoc($bak);
...
<div class="box box-warning" style="margin-right:3%">
            <div class="box-header with-border">
              <h3 class="box-title">Satılık İlan Güncelle</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="?sayfa=18&id=<?=$idm?>" method="post" enctype="multipart/form-data">  
                <!-- input states -->
                <div class="form-group has-success">
                  <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>İlan Başlığı Giriniz...</label>
                  <input type="text" class="form-control" id="inputSuccess" placeholder="İlan Başlığı Giriniz..." name="baslik" required value="<?=$baslik?>">
                 ...
                 <div class="form-group has-success">
                  ...
                  <input type="text" class="form-control" id="inputError" placeholder="Bu Alana İş Makinenizin Türünü Girmelisiniz ... ÖRNEĞİN : DOZER , SİLİNDİR , vb..." name="tur" required value="<?=$tur?>">
                 ...
                 <div class="form-group has-success">
                  ...
                  <input type="text" class="form-control" id="inputError" placeholder="Bu Alana İş Makinenizin Fiyatını Giriniz..." name="fiyat" required value="<?=$fiyat?>">
                 ...
                 <div class="form-group has-success">
                  ...
                  <input type="text" class="form-control" id="inputError" placeholder="Bu Alana İş Makinenizin Markasını Giriniz..." name="marka" required value="<?=$marka?>">
                ...
                <div class="form-group has-success">
                  ...
                  <input type="text" class="form-control" id="inputError" placeholder="Bu Alana İş Makinenizin Çalışma Saatini Giriniz..." name="saat" required value="<?=$saat?>">
                ...
                <div class="form-group has-success">
                  ...
                  <textarea class="form-control" rows="3" placeholder="İlana Ait Detay Giriniz... Örneğin makinenin üzerinde herhangi bir hasar yoktur...." name="detay" required ><?=$detay?></textarea>
                </div>
                <div class="form-group has-success">
