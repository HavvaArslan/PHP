...
if(isset($_SESSION["kullanici"]))
{
	...
	$kayitsayisi = @mysql_num_rows(@mysql_query("select * from kiralik "));
	...
	$bak = @mysql_query("select * from kiralik LIMIT $baslanacakkayit,$sayfadakikayitsayisi");
 ...
 <div class="col-md-4" style="margin-top:2%">
          <div class="box box-primary" style="margin-top:2%" >
            <div class="box-body box-profile" style="background:#00AA85">
              ...
              <a href="?sayfa=19&id=<?=$id?>" class="btn btn-success btn-block"><b>Değiştir</b></a>
              <a href="?sayfa=14&id=<?=$id?>" class="btn btn-success btn-block"><b>Sil</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
	...
	?>
          ...
          <div class="col-md-12">
					...
					for($sayfaindex =$sayfalama-$sagsolgosterimsayisi;$sayfaindex<=$sayfalama+$sagsolgosterimsayisi;$sayfaindex++)
						...
						?>
						<li><a href="<?php echo '?sayfa=15&sayfalama='.$sayfaindex ?>"><?php echo $sayfaindex ?></a></li>
    					<?php
						}
						}
						?>
