...
if(isset($_SESSION["kullanici"]))
{
	...
	$guncelle = @mysql_query("update  kiralik set baslik='$baslik',tur='$tur',fiyat='$fiyat',marka='$marka',yil='$yil',saat='$saat',detay='$detay',resimbir='$yeniresimadi',resimiki='$yeniresimadiiki',resimuc='$yeniresimadiuc',resimdort='$yeniresimadidort' where id='$id' ");
	if($guncelle)
	{
