...
if(isset($_SESSION["kullanici"]))
{
	...
	$kayitsayisi = @mysql_num_rows(@mysql_query("select * from slider "));
	...
	$bak = @mysql_query("select * from slider LIMIT $baslanacakkayit,$sayfadakikayitsayisi");
 ...
 <div class="col-md-4" style="margin-top:2%">
          <div class="box box-primary" style="margin-top:2%" >
            <div class="box-body box-profile" style="background:#00AA85">
              ...
              <a href="?sayfa=26&id=<?=$id?>" class="btn btn-success btn-block"><b>Sil</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
